...
bloco = {
  x: 50,
  //x: , << Espaço Entre A Parede Da Canvas E O Bloco
  y: 0,
  altura: 50,
...
obstaculos = {
  ...
  insere: function() {
    this._obs.push({
     ...
     largura: 50,
     // largura: ,  << Determina A Largura Dos Obstáculos Escala Menor Para Mais Fino
      altura: 20.5 + Math.floor(120 * Math.random()),
      //altura:  << Determina  Altura Dos Obstáculos Escala Menor Para Baixo Maior Para Cima
      cor: this.cores[Math.floor(5 * Math.random())]
    });
    
  this.tempoInsere = 30;  
  //this.tempoInsere = ;  << Determina Distância Dos Obstáculos Escala Para Baixo
